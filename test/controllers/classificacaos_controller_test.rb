...
class ClassificacaosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create classificacao" do
    assert_difference('Classificacao.count') do
      post classificacaos_url, params: { classificacao: { email: @classificacao.email, nome: @classificacao.nome } }
    end
  ...
  test "should update classificacao" do
    patch classificacao_url(@classificacao), params: { classificacao: { email: @classificacao.email, nome: @classificacao.nome } }
